    ...
    <div>
      ...
      <div className="mt-3 flex items-end gap-2">
        <textarea
          ...
          className="max-h-32 min-h-[42px] w-full resize-none rounded-[10px] border border-transparent bg-ivory px-3.5 py-2.5 text-subhead leading-relaxed text-ink placeholder:text-muted transition-colors focus:border-accent/40"
        />
        <button
          type="button"
          onClick={post}
